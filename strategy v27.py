...
# بازه‌ی تست به ۱۲ ماه قبل منتقل شد: به‌جای پایان‌دادن به «الان»، بازه‌ی
# ۶ ماهه‌ی تست به ۱۲ ماه پیش از الان ختم می‌شه - یعنی کلاً بازه‌ی
# [الان−۱۸ماه, الان−۱۲ماه] تست می‌شه، نه ۶ ماه اخیر.
OOS_OFFSET_MONTHS = 12
...
POSITION_MARGIN = 1000.0  # مارجین ثابت هر پوزیشن - تغییر کرد
LEVERAGE = 2.0            # لوریج ۲ برابر - تغییر کرد
...
TP_ATR_MULT = 3.04        # TP اصلی (نیمه‌ی اول پوزیشن) = ورود ± ۳.۰۴×ATR (افزایش ۰.۰۴)
TP3_ATR_MULT = 5.04       # تارگت۳ (نیمه‌ی دوم پوزیشن) = ورود ± ۵.۰۴×ATR (افزایش ۰.۰۴)

ADX_LEN = 14
ADX_MIN = 21               # فیلتر ADX - فقط بازار غیر-رنج
ADX_ENABLED = True         # دوباره فعال شد
