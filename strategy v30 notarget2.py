...
TARGET2_ENABLED = False  # تارگت۲ (شکست معکوس) برای مقایسه غیرفعال شد
...
def backtest(ltf_df, triggers, reversal_triggers, allowed_side):
    ...
    for i in range(max(PIVOT_LEN * 2, 20), n):
        ...
        if position is not None:
            ...
            # برای این مقایسه غیرفعال شده - فقط TP1 و TP3 فعالن.
            if TARGET2_ENABLED and ts in reversal_triggers:
