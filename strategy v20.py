...
TP_ATR_MULT = 3.0         # TP اصلی (نیمه‌ی اول پوزیشن) = ورود ± ۳×ATR
TP3_ATR_MULT = 5.0        # تارگت۳ (نیمه‌ی دوم پوزیشن) = ورود ± ۵×ATR
...
LTF_CANDIDATES = ["5m"]  # تایم مانیتورینگ/ورود - پول‌بک‌های ۵ دقیقه‌ای طبق درخواست
...
def print_combined_report(all_results, shared_capital=None):
    ...
    ۲) تعداد معامله در روز
    ۳) طول و مبلغ توالی‌های برد/باخت متوالی
    """
