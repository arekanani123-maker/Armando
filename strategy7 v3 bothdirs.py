...
MONTHS_BACK = 18          # طول خودِ بازه‌ی تست
...
SYMBOL_DIRECTION = {
    "XRP/USDT:USDT": "both",   # هردو جهت آزاد - تغییر کرد (فقط توی استراتژی ۷)
    "ETH/USDT:USDT": "both",   # هردو جهت آزاد - تغییر کرد (فقط توی استراتژی ۷)
